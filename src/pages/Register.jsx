        ...
        <div className="flex justify-center  px-6 py-10">
          <div className="w-full xl:w-3/4 lg:w-11/12 flex p-2 bg-linear-to-r from-blue-500 to-orange-600 rounded-xl">
            ...
            <div className="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
              ...
              {msg ? <p className="text-center"><Link to="/signin">Login here</Link></p> : <form onSubmit={handleOnSubmit} className="px-8 pt-6 mb-4 bg-white dark:bg-gray-800 rounded">
                <div className="md:flex md:justify-between">
                  <div className="mb-4 md:mr-2 md:mb-0 md:w-1/2">
                    ...
                    />
                    {formErr.firstName && <p className="text-red-500 text-[12px] -mt-2">{formErr.firstName}</p>}
                  </div>
                  <div className="mb-4 md:ml-2 md:w-1/2">
                    <Input
                      ...
                      onChange={handleOnChange}
                    />
                  {formErr.lastName && <p className="text-red-500 text-[12px] -mt-2">{formErr.lastName}</p>}
                  </div>
                </div>
                <div className="mb-4">                  
                  <Input
                    ...
                    onChange={handleOnChange}
                  />
                  {formErr.email && <p className="text-red-500 text-[12px] -mt-2">{formErr.email}</p>}
                </div>
                <div className="mb-4 md:flex md:justify-between">
                  <div className="mb-4 md:mr-2 md:mb-0 md:w-1/2">
                    <Input
                      ...
                      onChange={handleOnChange}
                    />
                    {formErr.password && <p className="text-red-500 text-[12px] -mt-2">{formErr.password}</p>}
                  </div>
                  <div className="md:ml-2 md:w-1/2">
                    ...
                    />
                    {formErr.cPassword && <p className="text-red-500 text-[12px] -mt-2">{formErr.cPassword}</p>}
                  </div>
                </div>
